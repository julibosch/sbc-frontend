    ...
    <>
      <div className="flex flex-col gap-10 h-screen pb-14">
        <div className="bg-login-form h-24 flex items-center justify-center shadow-md">
          ...
          <h2 className="text-center font-normal carter text-4xl uppercase text-slate-200 ml-5">
            scanner
          </h2>
        </div>
        ...
        {Object.keys(data).length !== 0 ? (
          <div
            className={`${
              estado === "deuda" ? "bg-red-300" : "bg-green-300"
            } w-3/4 h-44 mx-auto flex flex-col items-center transition-all`}
          >
            <div
              className={`${
                estado === "deuda" ? "bg-red-500" : "bg-green-500"
              } w-full h-12 flex justify-center items-center text-center text-xl uppercase font-bold transition-all`}
            >
              <p className="uppercase font-bold text-3xl sans-pro">{estado}</p>
            </div>
            <div className="flex flex-col items-center gap-5">
              <p className="mt-6 text-2xl font-bold uppercase sans-pro">
                {data.nombreCompleto}
              </p>
              <p>
                <span className="font-bold">Cuotas Adeudadas: </span>{" "}
          ...
          <div className="w-3/4 h-44 mx-auto flex flex-row justify-center items-center bg-qr h-min-fit p-2">
            <p className="text-center font-bold w-full text-xl">
              Aún no se ha escaneado ningun QR!
            </p>
          </div>
        )}
